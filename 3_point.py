...
q1_2= np.array([deg_to_rad(float(60)),
               mm_to_meter(float(0)),
               mm_to_meter(float(0))
               ])
q2_2 = np.array([deg_to_rad(float(60)),
               mm_to_meter(float(750)),
               mm_to_meter(float(0))
               ])
q3_2 = np.array([deg_to_rad(float(60)),
               mm_to_meter(float(750)),
               mm_to_meter(float(850))
               ])


q1_3 = np.array([deg_to_rad(float(-90)),
               mm_to_meter(float(0)),
               mm_to_meter(float(0))
               ])
q2_3 = np.array([deg_to_rad(float(-90)),
               mm_to_meter(float(750)),
               mm_to_meter(float(0))
               ])
q3_3 = np.array([deg_to_rad(float(-90)),
               mm_to_meter(float(750)),
               mm_to_meter(float(850))
               ])
...
traj3_return = rtb.jtraj(q3,q2,5)
traj2_return = rtb.jtraj(q2,q1,5)
traj1_2= rtb.jtraj(q1,q1_2,5)
traj2_2= rtb.jtraj(q1_2,q2_2,5)
traj3_2= rtb.jtraj(q2_2,q3_2,5)
traj3_2return= rtb.jtraj(q3_2,q2_2,5)
traj2_2return= rtb.jtraj(q2_2,q1_2,5)
traj1_3= rtb.jtraj(q1_2,q1_3,5)
traj2_3= rtb.jtraj(q1_3,q2_3,5)
traj3_3= rtb.jtraj(q2_3,q3_3,5)
traj3_3return= rtb.jtraj(q3_3,q2_3,5)
traj2_3return= rtb.jtraj(q2_3,q1_3,5)
traj1_3return= rtb.jtraj(q1_3,q0,5)
...
Cyl_Standard.plot(traj1_3return.q, block=True)